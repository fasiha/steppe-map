# -*- encoding: utf-8 -*-
"""
Script for https://www.nmrs.org.uk/wp-content/uploads/2016/04/UKcoal.jpg
which is 900x924, and has MD5 sum 1b628c0e64488a4f0ffe4497d833f6d0.
"""
...
if __name__ == "__main__":
    ...
    (lon, lat, x, y) = loaddata('UKcoal.points', wgs84=True)
    ...
    p, x2t, t2x, postfit = searchsolution2xy('tmerc', "lon_0,lat_0", [-2., 49], order=1)
